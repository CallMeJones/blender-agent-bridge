...
SPECS = tuple(ToolSpec(**payload) for payload in [{'name': 'get_blend_file_diagnostics',
 ...
 {'name': 'list_project_files',
  'description': 'List files and folders beneath the directory containing the current saved .blend. Hidden paths and '
                 'links are not traversed; unsaved projects are refused.',
  'input_schema': {'type': 'object',
                   'properties': {'relative_path': {'type': 'string',
                                                     'maxLength': 1024,
                                                     'description': 'Optional relative project subdirectory. Absolute, '
                                                                    'parent, and hidden paths are rejected.'},
                                  'recursive': {'type': 'boolean',
                                                'description': 'Recursively list ordinary subdirectories. Defaults to false.'},
                                  'max_entries': {'type': 'integer', 'minimum': 1, 'maximum': 1000,
                                                  'description': 'Maximum entries to return, from 1 to 1000.'}},
                   'additionalProperties': False},
  'contract': {'mutates_scene': False,
               'has_side_effects': False,
               'permissions': ['files:read'],
               'path_policy': 'Only relative paths contained by the directory of the current saved .blend are accepted. '
                              'Absolute paths, parent traversal, hidden components, symbolic links, and reparse points are blocked.'},
  'handler_key': 'list_project_files',
  'order': 82,
  'groups': ('project_files',),
  'exposure': 'catalog',
  'owner': 'project_workspace'},
 {'name': 'read_project_file',
  'description': 'Read a bounded UTF-8 or base64 file beneath the directory containing the current saved .blend. '
                 'Reads are capped at 4 MiB and cannot follow hidden paths or links.',
  'input_schema': {'type': 'object',
                   'properties': {'relative_path': {'type': 'string', 'maxLength': 1024,
                                                     'description': 'Relative path beneath the saved .blend directory.'},
                                  'encoding': {'type': 'string', 'enum': ['utf-8', 'base64']},
                                  'max_bytes': {'type': 'integer', 'minimum': 1, 'maximum': 4194304,
                                                'description': 'Maximum bytes to read, capped at 4194304.'}},
  ...
  'contract': {'mutates_scene': False,
               ...
               'path_policy': 'Only relative paths contained by the directory of the current saved .blend are accepted. '
                              'Absolute paths, parent traversal, hidden components, symbolic links, and reparse points are blocked.'},
  'handler_key': 'read_project_file',
  'order': 84,
  'groups': ('project_files',),
  'exposure': 'catalog',
  'owner': 'project_workspace'},
 {'name': 'write_project_file',
  'description': 'Create or replace a bounded UTF-8 or base64 file beneath the directory containing the current saved '
                 '.blend. Parent folders may be created; executable/script/library and .blend targets are blocked.',
  'input_schema': {'type': 'object',
                   'properties': {'relative_path': {'type': 'string', 'maxLength': 1024,
                                                     'description': 'Relative output path beneath the saved .blend directory.'},
                                  'content': {'type': 'string', 'maxLength': 5592408,
                                              'description': 'UTF-8 text or base64 content. Decoded content is capped at 4 MiB.'},
                                  'encoding': {'type': 'string', 'enum': ['utf-8', 'base64']},
                                  'overwrite': {'type': 'boolean',
                                                'description': 'Replace an existing file. Defaults to false.'},
                                  'create_dirs': {'type': 'boolean',
                                                  'description': 'Create ordinary parent directories. Defaults to true.'}},
  ...
  'contract': {'mutates_scene': False,
               ...
               'path_policy': 'Only relative paths contained by the directory of the current saved .blend are accepted. '
                              'Absolute paths, parent traversal, hidden components, symbolic links, reparse points, executable '
                              'or script targets, libraries, and .blend files are blocked.',
               'max_output_bytes': 4194304},
  'handler_key': 'write_project_file',
  'order': 86,
  'groups': ('project_files',),
  'exposure': 'catalog',
  'owner': 'project_workspace'},

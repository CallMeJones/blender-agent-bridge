...
ROUTING_FIXTURES = [
    ...
    },
    {
        ...
        "must_select": ["plan_advanced_scene_workflow", "plan_object_design", "create_procedural_object_kit", "add_geometry_nodes_modifier", "create_shader_material", "organize_scene_for_production"],
        "must_not_select": ["draft_script"],
    ...
    {
        "id": "object_design_mapper_first",
        "prompt": "Design a futuristic wall-mounted coffee machine with chrome pipes, a small display, buttons, and beveled body.",
        "must_select": ["plan_object_design", "plan_advanced_scene_workflow", "create_procedural_object_kit", "edit_mesh", "create_shader_material", "inspect_modeling_quality"],
        "must_not_select": ["draft_script"],
        "search": "object design coffee machine chrome pipes display buttons beveled body helper path",
        "search_before": [("plan_object_design", "draft_script"), ("create_procedural_object_kit", "draft_script")],
    },
    {
        ...
        "must_select": ["plan_advanced_scene_workflow", "plan_object_design", "create_procedural_object_kit", "inspect_modeling_quality", "capture_object_inspection_renders"],
        "must_not_select": ["draft_script"],

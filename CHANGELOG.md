...
- Simplified the Blender sidebar to keep bridge status, start/stop, MCP config, and pending preview/script decisions on the main surface while moving optional setup, assets, script trust, and diagnostics into a collapsed Advanced panel.

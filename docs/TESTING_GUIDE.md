...
- The 0.5.5 release candidate requires fresh final-commit evidence recorded in [LAUNCH_CHECKLIST.md](LAUNCH_CHECKLIST.md). Tagged CI repeats the complete Blender-background suite on Blender 4.2, 4.5, and 5.1 under Xvfb on Linux.

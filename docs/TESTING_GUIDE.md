...
- Canonical registry inventory: 222 Blender tool contracts across explicit domain modules.
- Normal agent catalog inventory: 221 tool definitions; the default surface exposes exactly five gateways. The opt-in `direct` surface adds 24 curated direct helpers.
...
- The published 0.4.0 artifacts were verified on 2026-07-23. The current unreleased 0.4.1 working line contains 217 unit tests and a 19-test Blender-background suite; tagged CI repeats the supported Blender matrix under Xvfb on Linux.

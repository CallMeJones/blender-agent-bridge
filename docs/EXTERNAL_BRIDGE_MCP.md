...
- `skills/blender-reference-modeling` teaches visual decomposition, evidence scoring, bounded repair, and pending-preview completion without category builders or canned geometry.

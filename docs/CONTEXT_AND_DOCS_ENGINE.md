...
- `create_image_texture_material(name, base_color_path, roughness_path, metallic_path, normal_path, alpha_path, emission_path, object_names, selected_only)`

...
![Dogfight hero](assets/egypt-dogfight-hero.jpg)

![Workflow strip](assets/egypt-workflow-strip.jpg)

![Short animated preview](assets/egypt-dogfight-preview.gif)

The included images have a restricted documentation-only licensing boundary because provenance for every depicted upstream mesh was not retained. Read [the complete provenance notice](assets/PROVENANCE.md) before reusing or submitting media.

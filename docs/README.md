...
- External script trust is a runtime-only binary switch: trust off refuses generated Python, trust on runs ordinary static-check-passing scripts, and active trust exposes `Revoke` in the sidebar.
